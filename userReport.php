                                    ...
                                    <table class="table header-border " id="userReport" >
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="printUserReport.php?userId=<?php echo $value['userId']; ?>" class="btn mb-1 btn-sm btn-outline-success">View</a>
