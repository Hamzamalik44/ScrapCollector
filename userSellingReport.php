...
$data = getUsersReportById($userData['id']);
            ...
            <div class="row page-titles mx-0">
                <div class="col p-md-0">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active"><a href="userSellingReport.php">Selling's Report</a></li>
                    </ol>
                </div>
            </div>
            ...
            <div class="container-fluid ">
                      <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-5">
                                       <h4 class="card-title">Selling's Report </h4>
                                    </div>
